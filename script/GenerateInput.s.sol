...
contract GenerateInput is Script {
    uint256 private constant AMOUNT = 25 * 1e18; // the amount that our addresses are going to be able to claim
    string[] types = new string[](2); //types of the values in the tree(address, amount)
    uint256 count; //Number of addresses that are going to be able to claim
    string[] whitelist = new string[](4); // array of addresses that are going to be able to claim

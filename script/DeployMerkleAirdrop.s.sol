...
contract DeployMerkleAirdrop is Script {
    ...
    function deployMerkleAirdrop() public returns (MerkleAirdrop, WaffleToken) {
        vm.startBroadcast();
        WaffleToken token = new WaffleToken();
    ...
    function run() external returns (MerkleAirdrop, WaffleToken) {
